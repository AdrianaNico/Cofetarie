...
SECRET_KEY = 'django-insecure-=m^+41gzlu*hlt%*%)41)ghhgmp(zlm9&p%x*q727)m49@0qm$'
...
INSTALLED_APPS = [
    ...
    'Cofetarie.apps.CofetarieConfig',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cofetarie',   # numele bazei de date
        'USER': 'adriana',      # username pt conexiunea la baza de date
        'PASSWORD': 'adriana',
